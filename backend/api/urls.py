...
urlpatterns = [
    ...
    path('auth/update-doctor/', views.update_doctor_detail, name='update_doctor_detail'),
    ...
    path('patient/dashboard-stats/', views.get_patient_dashboard_stats, name='get_patient_dashboard_stats'),
    ...
    path('report/pdf/<int:session_id>/', views.generate_pdf_report, name='generate_pdf_report'),
    ...
    path('public/doctors/', views.get_all_doctors, name='get_all_doctors'),
    ...
    path('profile/get/', views.get_profile_data, name='get_profile_data'),
